...
import the.autarch.android.newsgrid.bookmark.presentation.BookmarkIcon
import the.autarch.android.newsgrid.entry.data.EntryEntity
import the.autarch.android.newsgrid.navigation.Route

@Composable
fun EntryItem(item: EntryEntity, channelTitle: String, isBookmarked: Boolean) {
    ...
    Card(
        ...
        Box(modifier = itemSize, contentAlignment = Alignment.BottomStart) {
            ...
            Box(
                modifier = Modifier.background(Color.Black.copy(alpha = 0.6f)).padding(8.dp),
            ) {
                Text(
                    item.title,
